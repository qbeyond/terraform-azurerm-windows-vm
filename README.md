...
| <a name="input_data_disks"></a> [data\_disks](#input\_data\_disks) | `&lt;logical name of the data disk&gt; = {`  
...
&nbsp;&nbsp;&nbsp;&nbsp;on_demand_bursting_enabled: Optionally activate disk bursting. Only for Premium disk with size to 512 Gb up. Default false.  `}` | `{}` | no |
