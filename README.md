...
| <a name="input_data_disks"></a> [data_disks](#input_data_disks) | ```plaintext
logical name of the data disk = {
  ...
  write_accelerator_enabled: Optionally activate write acceleration for the data disk. Can only
