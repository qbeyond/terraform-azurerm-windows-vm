...
| <a name="input_disk_encryption"></a> [disk\_encryption](#input\_disk\_encryption) | Configuration for Azure Disk Encryption extension. When null, no ADE extension is created. | <pre>object({<br/>    publisher            = optional(string, "Microsoft.Azure.Security")<br/>    type                 = optional(string, "AzureDiskEncryption")<br/>    type_handler_version = optional(string, "2.2")<br/>    settings = object({<br/>      EncryptionOperation    = optional(string, "EnableEncryption")<br/>      KeyEncryptionAlgorithm = optional(string, "RSA-OAEP")<br/>      KeyVaultURL            = string<br/>      KeyVaultResourceId     = string<br/>      KeyEncryptionKeyURL    = string<br/>      KekVaultResourceId     = string<br/>      VolumeType             = optional(string, "All")<br/>    })<br/>  })</pre> | `null` | no |
